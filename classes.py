...
class Resistor:
    ...
    def draw(self, screen):
        ...
        pygame.draw.line(screen, (192, 192, 192), (self.resistorRect.left - 150, self.resistorRect.centery), (self.resistorRect.left, self.resistorRect.centery), 20)
        pygame.draw.line(screen, (192, 192, 192), (self.resistorRect.right + 150, self.resistorRect.centery), (self.resistorRect.right, self.resistorRect.centery), 20)